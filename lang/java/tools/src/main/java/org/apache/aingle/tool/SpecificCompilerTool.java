...
import org.apache.aingle.compiler.specific.SpecificCompiler.FieldVisibility;

/**
 * A Tool for compiling aingle protocols or schemas to Java classes using the AIngle
 * SpecificCompiler.
 */
...
public class SpecificCompilerTool implements Tool {
  ...
  private static final FileExtensionFilter SCHEMA_FILTER = new FileExtensionFilter("ain");
