...
public class TestCatTool {
  ...
  public void testCat() throws Exception {
    ...
    File input1 = generateData("input1.aingle", Type.INT, metadata, DEFLATE);
    File input2 = generateData("input2.aingle", Type.INT, metadata, SNAPPY);
    File input3 = generateData("input3.aingle", Type.INT, metadata, DEFLATE);

    File output = new File(DIR.getRoot(), name.getMethodName() + ".aingle");
    output.deleteOnExit();
...
//    glob input
  ...
  public void testDifferentSchemasFail() throws Exception {
    ...
    File input1 = generateData("input1.aingle", Type.STRING, metadata, DEFLATE);
    File input2 = generateData("input2.aingle", Type.INT, metadata, DEFLATE);
