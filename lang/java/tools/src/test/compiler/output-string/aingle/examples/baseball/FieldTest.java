...
public class FieldTest extends org.apache.aingle.specific.SpecificRecordBase implements org.apache.aingle.specific.SpecificRecord {
  private static final long serialVersionUID = 4609235620572341636L;
  public static final org.apache.aingle.Schema SCHEMA$ = new org.apache.aingle.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"FieldTest\",\"namespace\":\"aingle.examples.baseball\",\"doc\":\"Test various field types\",\"fields\":[{\"name\":\"number\",\"type\":\"int\",\"doc\":\"The number of the player\"},{\"name\":\"last_name\",\"type\":{\"type\":\"string\",\"aingle.java.string\":\"String\"}},{\"name\":\"timestamp\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}},{\"name\":\"timestampMicros\",\"type\":{\"type\":\"long\",\"logicalType\":\"timestamp-micros\"}},{\"name\":\"timeMillis\",\"type\":{\"type\":\"int\",\"logicalType\":\"time-millis\"}},{\"name\":\"timeMicros\",\"type\":{\"type\":\"long\",\"logicalType\":\"time-micros\"}}]}");
  public static org.apache.aingle.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();
static {
    MODEL$.addLogicalTypeConversion(new org.apache.aingle.data.TimeConversions.TimestampMillisConversion());
    MODEL$.addLogicalTypeConversion(new org.apache.aingle.data.TimeConversions.TimeMicrosConversion());
    MODEL$.addLogicalTypeConversion(new org.apache.aingle.data.TimeConversions.TimestampMicrosConversion());
    MODEL$.addLogicalTypeConversion(new org.apache.aingle.data.TimeConversions.TimeMillisConversion());
  }
  ...
  private static final org.apache.aingle.Conversion<?>[] conversions =
      new org.apache.aingle.Conversion<?>[] {
      null,
      null,
      new org.apache.aingle.data.TimeConversions.TimestampMillisConversion(),
      new org.apache.aingle.data.TimeConversions.TimestampMicrosConversion(),
      new org.apache.aingle.data.TimeConversions.TimeMillisConversion(),
      new org.apache.aingle.data.TimeConversions.TimeMicrosConversion(),
      null
  };

  @Override
  public org.apache.aingle.Conversion<?> getConversion(int field) {
   ...
   */
  public static aingle.examples.baseball.FieldTest.Builder newBuilder() {
    return new aingle.examples.baseball.FieldTest.Builder();
  }
   ...
   * @return A new FieldTest RecordBuilder
   */
  public static aingle.examples.baseball.FieldTest.Builder newBuilder(aingle.examples.baseball.FieldTest.Builder other) {
    if (other == null) {
      return new aingle.examples.baseball.FieldTest.Builder();
    } else {
      return new aingle.examples.baseball.FieldTest.Builder(other);
    }
  }
   ...
   * @return A new FieldTest RecordBuilder
   */
  public static aingle.examples.baseball.FieldTest.Builder newBuilder(aingle.examples.baseball.FieldTest other) {
    if (other == null) {
      return new aingle.examples.baseball.FieldTest.Builder();
    } else {
      return new aingle.examples.baseball.FieldTest.Builder(other);
   ...
   */
  @org.apache.aingle.specific.AIngleGenerated
  public static class Builder extends org.apache.aingle.specific.SpecificRecordBuilderBase<FieldTest>
    implements org.apache.aingle.data.RecordBuilder<FieldTest> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(aingle.examples.baseball.FieldTest.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(aingle.examples.baseball.FieldTest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.number)) {
        this.number = data().deepCopy(fields()[0].schema(), other.number);
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder setNumber(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder clearNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder clearLastName() {
      last_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder setTimestamp(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder clearTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder setTimestampMicros(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder clearTimestampMicros() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder setTimeMillis(java.time.LocalTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder clearTimeMillis() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder setTimeMicros(java.time.LocalTime value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.FieldTest.Builder clearTimeMicros() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.aingle.io.DatumWriter<FieldTest>
    WRITER$ = (org.apache.aingle.io.DatumWriter<FieldTest>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.aingle.io.DatumReader<FieldTest>
    READER$ = (org.apache.aingle.io.DatumReader<FieldTest>)MODEL$.createDatumReader(SCHEMA$);
