...
public class OptionalGettersAllFieldsTest extends org.apache.aingle.specific.SpecificRecordBase implements org.apache.aingle.specific.SpecificRecord {
  private static final long serialVersionUID = 874861432798554536L;
  public static final org.apache.aingle.Schema SCHEMA$ = new org.apache.aingle.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OptionalGettersAllFieldsTest\",\"namespace\":\"aingle.examples.baseball\",\"doc\":\"Test that optional getters are created for all fields\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"nullable_name\",\"type\":[\"string\",\"null\"]},{\"name\":\"favorite_number\",\"type\":[\"int\"]},{\"name\":\"nullable_favorite_number\",\"type\":[\"int\",\"null\"]}]}");
   ...
   */
  public static aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder newBuilder() {
    return new aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder();
  }
   ...
   * @return A new OptionalGettersAllFieldsTest RecordBuilder
   */
  public static aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder newBuilder(aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder other) {
    if (other == null) {
      return new aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder();
    } else {
      return new aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder(other);
    }
  }
   ...
   * @return A new OptionalGettersAllFieldsTest RecordBuilder
   */
  public static aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder newBuilder(aingle.examples.baseball.OptionalGettersAllFieldsTest other) {
    if (other == null) {
      return new aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder();
    } else {
      return new aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder(other);
   ...
   */
  @org.apache.aingle.specific.AIngleGenerated
  public static class Builder extends org.apache.aingle.specific.SpecificRecordBuilderBase<OptionalGettersAllFieldsTest>
    implements org.apache.aingle.data.RecordBuilder<OptionalGettersAllFieldsTest> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(aingle.examples.baseball.OptionalGettersAllFieldsTest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder setNullableName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder clearNullableName() {
      nullable_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder setFavoriteNumber(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder clearFavoriteNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder setNullableFavoriteNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersAllFieldsTest.Builder clearNullableFavoriteNumber() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.aingle.io.DatumWriter<OptionalGettersAllFieldsTest>
    WRITER$ = (org.apache.aingle.io.DatumWriter<OptionalGettersAllFieldsTest>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.aingle.io.DatumReader<OptionalGettersAllFieldsTest>
    READER$ = (org.apache.aingle.io.DatumReader<OptionalGettersAllFieldsTest>)MODEL$.createDatumReader(SCHEMA$);
