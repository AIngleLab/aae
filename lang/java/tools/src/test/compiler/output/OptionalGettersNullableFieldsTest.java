...
public class OptionalGettersNullableFieldsTest extends org.apache.aingle.specific.SpecificRecordBase implements org.apache.aingle.specific.SpecificRecord {
  private static final long serialVersionUID = 7830366875847294825L;
  public static final org.apache.aingle.Schema SCHEMA$ = new org.apache.aingle.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OptionalGettersNullableFieldsTest\",\"namespace\":\"aingle.examples.baseball\",\"doc\":\"Test that optional getters are created only for nullable fields\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"nullable_name\",\"type\":[\"string\",\"null\"]},{\"name\":\"favorite_number\",\"type\":[\"int\"]},{\"name\":\"nullable_favorite_number\",\"type\":[\"int\",\"null\"]}]}");
   ...
   */
  public static aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder newBuilder() {
    return new aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder();
  }
   ...
   * @return A new OptionalGettersNullableFieldsTest RecordBuilder
   */
  public static aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder newBuilder(aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder other) {
    if (other == null) {
      return new aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder();
    } else {
      return new aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder(other);
    }
  }
   ...
   * @return A new OptionalGettersNullableFieldsTest RecordBuilder
   */
  public static aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder newBuilder(aingle.examples.baseball.OptionalGettersNullableFieldsTest other) {
    if (other == null) {
      return new aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder();
    } else {
      return new aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder(other);
   ...
   */
  @org.apache.aingle.specific.AIngleGenerated
  public static class Builder extends org.apache.aingle.specific.SpecificRecordBuilderBase<OptionalGettersNullableFieldsTest>
    implements org.apache.aingle.data.RecordBuilder<OptionalGettersNullableFieldsTest> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(aingle.examples.baseball.OptionalGettersNullableFieldsTest other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder setNullableName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder clearNullableName() {
      nullable_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder setFavoriteNumber(java.lang.Object value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder clearFavoriteNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder setNullableFavoriteNumber(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public aingle.examples.baseball.OptionalGettersNullableFieldsTest.Builder clearNullableFavoriteNumber() {
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.aingle.io.DatumWriter<OptionalGettersNullableFieldsTest>
    WRITER$ = (org.apache.aingle.io.DatumWriter<OptionalGettersNullableFieldsTest>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.aingle.io.DatumReader<OptionalGettersNullableFieldsTest>
    READER$ = (org.apache.aingle.io.DatumReader<OptionalGettersNullableFieldsTest>)MODEL$.createDatumReader(SCHEMA$);
