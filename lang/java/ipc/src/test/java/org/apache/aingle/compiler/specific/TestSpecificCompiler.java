...
import org.apache.aingle.TestProtocolParsing;
import org.apache.aingle.TestSchema;
import org.apache.aingle.TestAnnotation;
...
import org.apache.aingle.compiler.specific.SpecificCompiler.OutputFile;
...
public class TestSpecificCompiler {
  ...
  public void testManglingForProtocols() throws IOException {
    ...
    assertTrue(errType.contains("public class finally$ extends org.apache.aingle.specific.SpecificExceptionBase"));
  ...
  public void testSchemaWithDocs() {
    ...
    for (OutputFile o : outputs) {
      ...
      if (o.path.endsWith("very_inner_fixed.java")) {
        ...
        assertTrue(o.contents.contains("@org.apache.aingle.specific.FixedSize(1)"));
      }
  ...
  public void testNeedCompile() throws IOException, InterruptedException {
    String schema = "" + "{ \"name\": \"Foo\", \"type\": \"record\", "
        + "  \"fields\": [ {\"name\": \"package\", \"type\": \"string\" },"
        + "                {\"name\": \"short\", \"type\": \"Foo\" } ] }";
    File inputFile = new File(INPUT_DIR.getRoot().getPath(), "input.ain");
