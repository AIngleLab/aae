...
import org.apache.aingle.test.http.HttpMethod;
import org.apache.aingle.test.http.HttpRequest;
import org.apache.aingle.test.http.HttpURI;
import org.apache.aingle.test.http.NetworkType;
import org.apache.aingle.test.http.QueryParameter;
import org.apache.aingle.test.http.Request;
import org.apache.aingle.test.http.UserAgent;
import org.apache.aingle.test.nullable.RecordWithNullables;
...
public class TestSpecificBuilderTree {
  ...
  @Test(expected = AIngleMissingFieldException.class)
  public void failOnIncompleteTree() {
    try {
      createPartialBuilder().build();
    } catch (AIngleMissingFieldException amfe) {
