...
package org.apache.aingle.hadoop.util;

import java.util.Comparator;

/**
 * Compares AIngle string data (data with schema <i>"string"</i>).
 *
 * <p>
 * The only case where comparing AIngle objects does not work using their natural
 * order is when the schema is <i>"string"</i>. The AIngle string schema maps to
 ...
 * <code>Utf8</code> objects that are both valid when working with AIngle strings.
 * </p>
 *
 * @param <T> The type of object to compare.
 */
public class AIngleCharSequenceComparator<T> implements Comparator<T> {
  /** A singleton instance. */
  public static final AIngleCharSequenceComparator<CharSequence> INSTANCE = new AIngleCharSequenceComparator<>();

  /** {@inheritDoc} */
  @Override
  public int compare(T o1, T o2) {
    if (!(o1 instanceof CharSequence) || !(o2 instanceof CharSequence)) {
      throw new RuntimeException("Attempted use of AIngleCharSequenceComparator on non-CharSequence objects: "
