...
public class TetherJob extends Configured {
  ...
  public static final String TETHER_EXEC = "aingle.tether.executable";
  public static final String TETHER_EXEC_ARGS = "aingle.tether.executable_args";
  public static final String TETHER_EXEC_CACHED = "aingle.tether.executable_cached";
  public static final String TETHER_PROTOCOL = "aingle.tether.protocol";

  /** Get the URI of the application's executable. */
  public static URI getExecutable(JobConf job) {
    try {
      return new URI(job.get("aingle.tether.executable"));
