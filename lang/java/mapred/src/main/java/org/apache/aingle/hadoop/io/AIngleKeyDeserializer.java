...
/**
 * Deserializes AIngleKey objects within Hadoop.
 *
 * @param <D> The java type of the aingle data to deserialize.
 *
 * @see AIngleDeserializer
 */
public class AIngleKeyDeserializer<D> extends AIngleDeserializer<AIngleWrapper<D>, D> {
  /**
   * Constructor.
   *
   ...
   */
  public AIngleKeyDeserializer(Schema writerSchema, Schema readerSchema, ClassLoader classLoader) {
   ...
   */
  public AIngleKeyDeserializer(Schema writerSchema, Schema readerSchema, DatumReader<D> datumReader) {
    super(writerSchema, readerSchema, datumReader);
  }

  /**
   * Creates a new empty <code>AIngleKey</code> instance.
   *
   * @return a new empty AIngleKey.
   */
  @Override
  protected AIngleWrapper<D> createAIngleWrapper() {
    return new AIngleKey<>(null);
  }
}
