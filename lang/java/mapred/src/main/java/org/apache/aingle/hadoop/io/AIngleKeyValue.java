...
/**
 * A helper object for working with the AIngle generic records that are used to
 * store key/value pairs in an AIngle container file.
 *
 * @param <K> The java type for the key.
 * @param <V> The java type for the value.
 */
public class AIngleKeyValue<K, V> {
  ...
  public static final String KEY_VALUE_PAIR_RECORD_NAMESPACE = "org.apache.aingle.mapreduce";
   ...
   */
  public AIngleKeyValue(GenericRecord keyValueRecord) {
   ...
   *
   * @return The key/value AIngle generic record.
   */
   ...
   */
  public static class Iterator<K, V> implements java.util.Iterator<AIngleKeyValue<K, V>> {
