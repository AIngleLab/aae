...
import org.apache.aingle.ipc.SaslSocketTransceiver;
...
public abstract class TetherTask<IN, MID, OUT> {
  ...
  void open(int inputPort) throws IOException {
    ...
    String clientPortString = System.getenv("AINGLE_TETHER_OUTPUT_PORT");
    String protocol = System.getenv("AINGLE_TETHER_PROTOCOL");
    if (clientPortString == null)
      throw new RuntimeException("AINGLE_TETHER_OUTPUT_PORT env var is null");
    ...
    if (protocol.equals("http")) {
      ...
      throw new RuntimeException("AINGLET_TETHER_PROTOCOL=" + protocol + " but this protocol is unsupported");
    }
