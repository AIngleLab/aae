...
public class TestAIngleCharSequenceComparator {
  private AIngleCharSequenceComparator<CharSequence> mComparator;

  @Before
  public void setup() {
    mComparator = new AIngleCharSequenceComparator<>();
  }
