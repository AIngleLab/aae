...
/** Utilities for serializing Thrift data in AIngle format. */
public class ThriftData extends GenericData {
  ...
  protected String getSchemaName(Object datum) {
    ...
    // to aingle INT for thrift's optional fields
  ...
  private Schema getSchema(FieldValueMetaData f) {
    ...
    case TType.MAP:
      ...
      if (mapMeta.keyMetaData.type != TType.STRING)
        throw new AIngleRuntimeException("Map keys must be strings: " + f);
