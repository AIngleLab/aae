...
import static org.apache.aingle.TestCircularReferences.Reference;
import static org.apache.aingle.TestCircularReferences.Referenceable;
...
import org.apache.aingle.TestCircularReferences.ReferenceManager;
...
public class TestGenericData {
  ...
  public void testMapWithNonStringKeyToStringIsJson() throws Exception {
    ...
    java.io.File f = new java.io.File(getClass().getResource("/SchemaBuilder.ain").toURI());
    filePair.put(f, "File");
  ...
  // org.apache.parquet.aingle.TestCircularReferences
  @Test
