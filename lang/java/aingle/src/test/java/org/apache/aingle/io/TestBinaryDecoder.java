...
public class TestBinaryDecoder {
  ...
  public void testNegativeStringLength() throws IOException {
    ...
    Assert.assertThrows("Malformed data. Length is negative: -1", AIngleRuntimeException.class, bd::readString);
  }
  ...
  public void testNegativeBytesLength() throws IOException {
    ...
    Assert.assertThrows("Malformed data. Length is negative: -1", AIngleRuntimeException.class, () -> bd.readBytes(null));
  }
  ...
  public void testBytesMaxLengthProperty() throws IOException {
    ...
    try {
      System.setProperty("org.apache.aingle.limits.bytes.maxLength", Long.toString(maxLength));
      Decoder bd = factory.binaryDecoder(bad, null);

      Assert.assertThrows("Bytes length " + (maxLength + 1) + " exceeds maximum allowed", AIngleRuntimeException.class,
          () -> bd.readBytes(null));
    } finally {
      System.clearProperty("org.apache.aingle.limits.bytes.maxLength");
    }
  }
