...
import org.apache.aingle.data.TimeConversions;
...
public class TestReflectLogicalTypes {
  ...
  public static class DecimalRecordBytes {
    ...
    @AIngleSchema("{" + "\"type\": \"bytes\"," + "\"logicalType\": \"decimal\"," + "\"precision\": 9," + "\"scale\": 2"
        + "}")
  ...
  public void testDecimalBytes() throws IOException {
    ...
    Assert.assertEquals("Should have the correct record name", "org.apache.aingle.reflect.TestReflectLogicalTypes",
        schema.getNamespace());
  ...
  public static class DecimalRecordFixed {
    // scale is required and will not be set by the conversion
    @AIngleSchema("{" + "\"name\": \"decimal_9\"," + "\"type\": \"fixed\"," + "\"size\": 4,"
  ...
  public static class PairRecord {
    @AIngleSchema("{" + "\"name\": \"Pair\"," + "\"type\": \"record\"," + "\"fields\": ["
  ...
  public void testReadUUIDMissingLogicalTypeUnsafe() throws IOException {
    String unsafeValue = System.getProperty("aingle.disable.unsafe");
    try {
      ...
      if (unsafeValue != null) {
        System.setProperty("aingle.disable.unsafe", unsafeValue);
      }
    }
  }
  ...
  public void testReflectedSchemaLocalDateTime() {
    ...
    Assert.assertEquals("Should have the correct record name", "org.apache.aingle.reflect", actual.getNamespace());
