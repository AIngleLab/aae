...
public class TestSchemaValidation {
  ...
  public static final org.apache.aingle.Schema recursiveSchema = new org.apache.aingle.Schema.Parser().parse(
      "{\"type\":\"record\",\"name\":\"Node\",\"namespace\":\"aingle\",\"fields\":[{\"name\":\"value\",\"type\":[\"null\",\"Node\"],\"default\":null}]}");

  /**
   * Unit test to verify that recursive schemas can be validated. See AINGLE-2122.
   */
  @Test
  public void testRecursiveSchemaValidation() throws SchemaValidationException {
    // before AINGLE-2122, this would cause a StackOverflowError
