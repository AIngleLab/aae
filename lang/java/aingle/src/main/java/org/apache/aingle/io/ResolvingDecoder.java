...
public class ResolvingDecoder extends ValidatingDecoder {
   ...
   * the field values.)
   *
   * @throws AIngleTypeException If we're not starting a new record
   *
   */
  ...
  public int readEnum() throws IOException {
    ...
    if (o instanceof Integer) {
      ...
      throw new AIngleTypeException((String) o);
    }
  }
  ...
  public Symbol doAction(Symbol input, Symbol top) throws IOException {
    ...
    if (top instanceof Symbol.ResolvingAction) {
      ...
      if (t.reader != input) {
        throw new AIngleTypeException("Found " + t.reader + " while looking for " + input);
      } else {
        return t.writer;
      }
      ...
      throw new AIngleTypeException(((Symbol.ErrorAction) top).msg);
      ...
      throw new AIngleTypeException("Unknown action: " + top);
    }
    return null;
  }
