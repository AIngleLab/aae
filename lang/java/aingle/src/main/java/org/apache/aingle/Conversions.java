...
public class Conversions {
  ...
  public static class DecimalConversion extends Conversion<BigDecimal> {
    ...
    private static BigDecimal validate(final LogicalTypes.Decimal decimal, BigDecimal value) {
      ...
      if (valuePrecision > precision) {
        if (scaleAdjusted) {
          throw new AIngleTypeException("Cannot encode decimal with precision " + valuePrecision + " as max precision "
   ...
   * @param type       The {@link org.apache.aingle.LogicalType} of datum. Cannot be
