...
public class SpecificData extends GenericData {
  ...
  private static final ClassValue<SpecificData> MODEL_CACHE = new ClassValue<SpecificData>() {
    ...
    protected SpecificData computeValue(Class<?> type) {
      ...
      try {
        ...
        throw new AIngleRuntimeException("while trying to access field MODEL$ on " + type.getCanonicalName(), e);
      }
    }
  };
  ...
  public static final Set<String> RESERVED_WORDS = new HashSet<>(Arrays.asList(
      ...
      // Class names used internally by the aingle code generator
      "Builder"));
   ...
   * get the correct {@link org.apache.aingle.Conversion} instances for the class.
  ...
  private boolean useCustomCoderFlag = Boolean
      .parseBoolean(System.getProperty("org.apache.aingle.specific.use_custom_coders", "false"));
   ...
   * property <code>org.apache.aingle.specific.use_custom_coders</code>, and can be
   * set dynamically by {@link SpecificData#useCustomCoders()}. See <a
   * href="https://apache.aingle.ai/docs/current/gettingstartedjava.html#Beta+feature:+Generating+faster+code"Getting
  ...
  public Class getClass(Schema schema) {
    ...
    case NULL:
      return Void.TYPE;
    default:
      throw new AIngleRuntimeException("Unknown type: " + schema);
    }
  }
  ...
  public Schema getSchema(java.lang.reflect.Type type) {
    try {
      ...
      throw (e instanceof AIngleRuntimeException) ? (AIngleRuntimeException) e : new AIngleRuntimeException(e);
    }
  }
  ...
  protected Schema createSchema(java.lang.reflect.Type type, Map<String, Schema> names) {
    if (type instanceof Class && CharSequence.class.isAssignableFrom((Class) type))
      ...
      if (Collection.class.isAssignableFrom(raw)) { // array
        ...
        if (!(key instanceof Class && CharSequence.class.isAssignableFrom((Class) key)))
          throw new AIngleTypeException("Map key class not CharSequence: " + key);
      ...
      if (schema == null)
        try {
          ...
          throw new AIngleRuntimeException("Not a Specific class: " + c);
        } catch (IllegalAccessException e) {
    ...
    throw new AIngleTypeException("Unknown type: " + type);
  }
   ...
   * {@link org.apache.aingle.Schema} parameter, otherwise use a no-arg constructor.
   */
