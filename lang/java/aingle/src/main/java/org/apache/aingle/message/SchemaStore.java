...
package org.apache.aingle.message;
...
/**
 * Interface for classes that can provide aingle schemas by fingerprint.
 */
public interface SchemaStore {

  /**
   * Retrieves a fingerprint by its AINGLE-CRC-64 fingerprint.
   * 
   * @param fingerprint an AINGLE-CRC-64 fingerprint long
   * @return a Schema with the given fingerprint, or null
   */
  Schema findByFingerprint(long fingerprint);

  /**
   * A map-based cache of schemas by AINGLE-CRC-64 fingerprint.
   * <p>
  ...
  class Cache implements SchemaStore {
    ...
    /**
     * Adds a schema to this cache that can be retrieved using its AINGLE-CRC-64
     * fingerprint.
     *
