...
import org.apache.aingle.Resolver.Action;
import org.apache.aingle.Resolver.Container;
import org.apache.aingle.Resolver.EnumAdjust;
import org.apache.aingle.Resolver.Promote;
import org.apache.aingle.Resolver.ReaderUnion;
import org.apache.aingle.Resolver.RecordAdjust;
import org.apache.aingle.Resolver.Skip;
import org.apache.aingle.Resolver.WriterUnion;
...
import org.apache.aingle.generic.GenericData.InstanceSupplier;
import org.apache.aingle.generic.GenericDatumReader;
import org.apache.aingle.generic.GenericEnumSymbol;
import org.apache.aingle.generic.GenericFixed;
import org.apache.aingle.generic.IndexedRecord;
import org.apache.aingle.io.FastReaderBuilder.RecordReader.Stage;
import org.apache.aingle.io.parsing.ResolvingGrammarGenerator;
import org.apache.aingle.reflect.ReflectionUtil;
...
import org.apache.aingle.util.WeakIdentityHashMap;
...
public class FastReaderBuilder {
  ...
  private FieldReader getNonConvertedReader(Action action) throws IOException {
    ...
    case ERROR:
      return (old, decoder) -> {
        throw new AIngleTypeException(action.toString());
      };
    default:
      throw new IllegalStateException("Error getting reader for action type " + action.getClass());
    }
  ...
  private FieldReader createEnumReader(EnumAdjust action) {
    return reusingReader((reuse, decoder) -> {
      ...
      if (resultObject == null) {
        throw new AIngleTypeException("No match for " + action.writer.getEnumSymbols().get(index));
      }
      return resultObject;
    });
  }
