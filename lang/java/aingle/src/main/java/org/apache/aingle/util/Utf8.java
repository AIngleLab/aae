...
public class Utf8 implements Comparable<Utf8>, CharSequence {
  private static final String MAX_LENGTH_PROPERTY = "org.apache.aingle.limits.string.maxLength";
  ...
  private static void checkLength(int length) {
    if (length > MAX_LENGTH) {
      throw new AIngleRuntimeException("String length " + length + " exceeds maximum allowed");
    }
  }
