...
public class GenericDatumReader<D> implements DatumReader<D> {
  ...
  protected Object readWithoutConversion(Object old, Schema expected, ResolvingDecoder in) throws IOException {
    ...
    case NULL:
      ...
      return null;
    default:
      throw new AIngleRuntimeException("Unknown type: " + expected);
    }
  }
   ...
   * {@link #readString(Object, org.apache.aingle.io.Decoder)}.
   */
   ...
   * representations. By default, returns {@link GenericFixed}.
   *
   * @deprecated As of AIngle 1.6.0 this method has been moved to
