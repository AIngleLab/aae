...
import org.apache.aingle.InvalidAIngleMagicException;
import org.apache.aingle.io.DecoderFactory;
import org.apache.commons.compress.utils.IOUtils;
import org.apache.aingle.io.DatumReader;
import static org.apache.aingle.file.DataFileConstants.SYNC_SIZE;
import static org.apache.aingle.file.DataFileConstants.MAGIC;
...
public class DataFileReader<D> extends DataFileStream<D> implements FileReader<D> {
  ...
  public static <D> FileReader<D> openReader(SeekableInput in, DatumReader<D> reader) throws IOException {
    if (in.length() < MAGIC.length)
      throw new InvalidAIngleMagicException("Not an AIngle data file");
  ...
  public void sync(final long position) throws IOException {
    ...
    if ((position == 0L) && (getMeta("aingle.sync") != null)) {
