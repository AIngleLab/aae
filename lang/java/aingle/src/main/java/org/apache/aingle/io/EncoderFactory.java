...
public class EncoderFactory {
   ...
   * configuration methods throw AIngleRuntimeExceptions if called.
   */
   ...
   *             this size will be segmented into blocks according to the AIngle
   ...
   * OutputStream.
   * <p/>
   * The returned BinaryEncoder implements the AIngle binary encoding using blocks
  ...
  private static class DefaultEncoderFactory extends EncoderFactory {
    @Override
    public EncoderFactory configureBlockSize(int size) {
      throw new AIngleRuntimeException("Default EncoderFactory cannot be configured");
    }
