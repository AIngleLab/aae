...
/**
 * {@link org.apache.aingle.io.DatumReader DatumReader} for existing classes via
 * Java reflection.
 */
public class ReflectDatumReader<T> extends SpecificDatumReader<T> {
  ...
  protected void addToArray(Object array, long pos, Object e) {
    throw new AIngleRuntimeException("reflectDatumReader does not use addToArray");
  }
  ...
  protected Object readArray(Object old, Schema expected, ResolvingDecoder in) throws IOException {
    ...
    if (array instanceof Collection) {
      ...
      if (ReflectData.isNonStringMapSchema(expected)) {
        ...
        throw new AIngleRuntimeException(msg);
      }
    } else {
      ...
      if (accessor != null) {
        ...
        if (accessor.isStringable()) {
          try {
            ...
            throw new AIngleRuntimeException("Failed to read Stringable", e);
          }
        }
        ...
        if (logicalType != null) {
          ...
          if (conversion != null) {
            try {
              ...
              throw new AIngleRuntimeException("Failed to set " + field);
            }
            return;
          }
        }
