...
import org.apache.aingle.UnknownAIngleCodecException;
...
/** Read files written by AIngle version 1.2. */
public class DataFileReader12<D> implements FileReader<D>, Closeable {
  ...
  public DataFileReader12(SeekableInput sin, DatumReader<D> reader) throws IOException {
    ...
    if (!Arrays.equals(MAGIC, magic))
      throw new InvalidAIngleMagicException("Not a data file.");
    ...
    if (codec != null && !codec.equals(NULL_CODEC)) {
      throw new UnknownAIngleCodecException("Unknown codec: " + codec);
    }
