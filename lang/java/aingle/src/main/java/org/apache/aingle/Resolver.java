...
import org.apache.aingle.Schema.SeenPair;
import org.apache.aingle.Resolver.ErrorAction.ErrorType;
 ...
 * helpful to study {@link org.apache.aingle.io.parsing.ResolvingGrammarGenerator}
...
public class Resolver {
  ...
  /**
   * In this case there is an error. We put error Actions into trees because AIngle
   ...
   * promotion"), and whent the promotion is one allowed by the AIngle spec.
   */
  ...
  public static class ReaderUnion extends Action {
    ...
    // Note: This code was taken verbatim from the 1.8.x branch of AIngle. It
    // implements
