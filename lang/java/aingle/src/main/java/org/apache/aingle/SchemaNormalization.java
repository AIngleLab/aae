...
public class SchemaNormalization {
  ...
  /**
   * Returns "Parsing Canonical Form" of a schema as defined by AIngle spec.
   */
   ...
   * equals the string <code>"CRC-64-AINGLE"</code>, then the result of
   ...
   * <p>
   * Recommended AIngle practice dictates that <code>"CRC-64-AINGLE"</code> is used
  ...
  public static byte[] fingerprint(String fpName, byte[] data) throws NoSuchAlgorithmException {
    if (fpName.equals("CRC-64-AINGLE")) {
  ...
  /**
   * Returns the 64-bit Rabin Fingerprint (as recommended in the AIngle spec) of a
   * byte string.
   */
