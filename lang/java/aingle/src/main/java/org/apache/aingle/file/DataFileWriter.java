...
import org.apache.aingle.file.DataFileStream.DataBlock;
...
public class DataFileWriter<D> implements Closeable, Flushable {
  ...
  private void assertOpen() {
    if (!isOpen)
      throw new AIngleRuntimeException("not open");
  }

  private void assertNotOpen() {
    if (isOpen)
      throw new AIngleRuntimeException("already open");
  }
