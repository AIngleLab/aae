...
/**
 * Low-level support for serializing AIngle values.
 * <p/>
...
public abstract class Encoder implements Flushable {
   ...
   * 
   * @throws AIngleTypeException If this is a stateful writer and a null is not
   *                           expected
   */
   ...
   * 
   * @throws AIngleTypeException If this is a stateful writer and a boolean is not
   *                           expected
   */
   ...
   * 
   * @throws AIngleTypeException If this is a stateful writer and an integer is not
   *                           expected
   */
   ...
   * 
   * @throws AIngleTypeException If this is a stateful writer and a long is not
   *                           expected
   */
   ...
   * 
   * @throws IOException
   * @throws AIngleTypeException If this is a stateful writer and a float is not
   *                           expected
   */
   ...
   * Write a double.
   * 
   * @throws AIngleTypeException If this is a stateful writer and a double is not
   *                           expected
   */
   ...
   * 
   * @throws AIngleTypeException If this is a stateful writer and a char-string is
   *                           not expected
   */
   ...
   * String to a {@link org.apache.aingle.util.Utf8}. Some Encoder implementations
   ...
   * {@link org.apache.aingle.util.Utf8} it writes this directly, otherwise the
   ...
   * Write a byte string.
   * 
   * @throws AIngleTypeException If this is a stateful writer and a byte-string is
   *                           not expected
   */
   ...
   * 
   * @param e
   * @throws AIngleTypeException If this is a stateful writer and an enumeration is
   ...
   * </pre>
   * 
   * @throws AIngleTypeException If this is a stateful writer and an array is not
   *                           expected
   */
   ...
   * information.
   * 
   * @throws AIngleTypeException If called outside of an array or map context
   */
   ...
   * usage information.
   *
   * @throws AIngleTypeException If items written does not match count provided to
   *                           {@link #writeArrayStart}
   * @throws AIngleTypeException If not currently inside an array
   */
   ...
   * </pre>
   * 
   * @throws AIngleTypeException If this is a stateful writer and a map is not
   *                           expected
   */
   ...
   * @throws AIngleTypeException If items written does not match count provided to
   *                           {@link #writeMapStart}
   * @throws AIngleTypeException If not currently inside a map
   */
