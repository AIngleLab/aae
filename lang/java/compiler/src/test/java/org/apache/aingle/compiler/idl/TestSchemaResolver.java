 ...
 */
package org.apache.aingle.compiler.idl;
...
public class TestSchemaResolver {
  ...
  public void testIsUnresolvedSchemaError1() {
    // No "org.apache.aingle.compiler.idl.unresolved.name" property
  ...
  public void testIsUnresolvedSchemaError2() {
    ...
    Schema s = SchemaBuilder.record("R").prop("org.apache.aingle.compiler.idl.unresolved.name", "x").fields().endRecord();
    SchemaResolver.getUnresolvedSchemaName(s);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testIsUnresolvedSchemaError3() {
    // Namespace not "org.apache.aingle.compiler".
    Schema s = SchemaBuilder.record("UnresolvedSchema").prop("org.apache.aingle.compiler.idl.unresolved.name", "x")
        .fields().endRecord();
    SchemaResolver.getUnresolvedSchemaName(s);
  }
