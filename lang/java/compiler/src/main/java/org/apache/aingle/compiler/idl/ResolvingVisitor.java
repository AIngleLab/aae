...
import org.apache.aingle.compiler.schema.SchemaVisitor;
import org.apache.aingle.compiler.schema.SchemaVisitorAction;
import org.apache.aingle.compiler.schema.Schemas;
  ...
  public SchemaVisitorAction visitNonTerminal(final Schema nt) {
    ...
    if (type == Schema.Type.RECORD) {
      if (SchemaResolver.isUnresolvedSchema(nt)) {
        ...
        if (resSchema == null) {
          throw new AIngleTypeException("Unable to resolve " + unresolvedSchemaName);
        }
