 ...
 * Execute the {@link #org.apache.aingle.test.Simple.add(int, int)} RPC to
 * complete the AIngle IPC handshake. 2a. In a background thread, wait for the
 * waitLatch. 3a. In the main thread, invoke
 * {@link #org.apache.aingle.test.Simple.hello(String)} with the argument "wait".
 ...
 * {@link #org.apache.aingle.test.Simple.ack()} to be invoked. 2b. The background
 ...
 * {@link #org.apache.aingle.test.Simple.ack()} in the background thread, which
