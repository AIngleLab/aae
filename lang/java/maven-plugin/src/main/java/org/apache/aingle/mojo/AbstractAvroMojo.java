...
/**
 * Base for AIngle Compiler Mojos.
 */
public abstract class AbstractAIngleMojo extends AbstractMojo {
  /**
   * The source directory of aingle files. This directory is added to the classpath
   ...
   *            default-value="${basedir}/src/main/aingle"
   */
  private File sourceDirectory;

  /**
   * @parameter property="outputDirectory"
   *            default-value="${project.build.directory}/generated-sources/aingle"
   */
  private File outputDirectory;

  /**
   * @parameter property="sourceDirectory"
   *            default-value="${basedir}/src/test/aingle"
   */
  private File testSourceDirectory;

  /**
   * @parameter property="outputDirectory"
   *            default-value="${project.build.directory}/generated-test-sources/aingle"
   */
  ...
  /**
   * The Java type to use for AIngle strings. May be one of CharSequence, String or
   ...
   * templates included with the aingle-maven-plugin.
   *
   * @parameter property="templateDirectory"
   */
  protected String templateDirectory = "/org/apache/aingle/compiler/specific/templates/java/classic/";
   ...
   * Velocity templates by AIngle compiler.
   *
   ...
   * {@link org.apache.aingle.Conversion} implementations to add to the compiler.
  ...
  /**
   * A set of fully qualified class names of custom
   * {@link org.apache.aingle.LogicalTypes.LogicalTypeFactory} implementations to
