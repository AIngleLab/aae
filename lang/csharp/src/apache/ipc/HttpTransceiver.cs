...
namespace AIngle.ipc
{
    public class HttpTransceiver : Transceiver
    {
        ...
        public HttpTransceiver(Uri serviceUri, int timeoutMs)
        {
            ...
            _modelRequest.ContentType = "aingle/binary";
        ...
        protected HttpWebRequest CreateAIngleHttpRequest(long contentLength)
        {
            ...
            //the properties which are defined by AIngle specification
            wr.Method = "POST";
            wr.ContentType = "aingle/binary";
        ...
        {
            _httpRequest = CreateAIngleHttpRequest(CalculateLength(buffers));
