...
namespace org.apache.aingle.test
{
	...
	/// </summary>
	public abstract class Simple : AIngle.Specific.ISpecificProtocol
	{
		private static readonly AIngle.Protocol protocol = AIngle.Protocol.Parse("{\r\n  \"protocol\": \"Simple\",\r\n  \"namespace\": \"org.apache.aingle.test\",\r\n  \"doc\": \"Pro" +
				...
				"ame\": \"MD5\",\r\n      \"namespace\": \"org.apache.aingle.test\",\r\n      \"size\": 16,\r\n   " +
				"   \"javaAnnotation\": \"org.apache.aingle.TestAnnotation\"\r\n    },\r\n    {\r\n      \"typ" +
		...
		public void Request(AIngle.Specific.ICallbackRequestor requestor, string messageName, object[] args, object callback)
		{
			switch(messageName)
			{
				...
				case "echo":
				requestor.Request<org.apache.aingle.test.TestRecord>(messageName, args, callback);
				break;
		...
		public abstract org.apache.aingle.test.TestRecord echo(org.apache.aingle.test.TestRecord record);
