...
namespace AIngle.Test.Ipc
{
    ...
    {
        private static org.apache.aingle.test.Message CreateMessage()
        {
            var msg = new org.apache.aingle.test.Message
                          {
                              to = "wife",
                              from = "husband",
                              body = "I love you!"
        ...
        public class MailImpl : Mail
        {
            ...
            public override String send(org.apache.aingle.test.Message message)
            {
            ...
            public override void fireandforget(org.apache.aingle.test.Message message)
            {
                allMessages.Signal();
            }
