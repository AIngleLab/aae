...
namespace AIngle.Test
{
    ...
    public class BinaryCodecTests
    {
        ...
        /// <summary>
        /// Writes an aingle type T with value t into a stream using the encode method e
        /// and reads it back using the decode method d and verifies that
        /// the value read back is the same as the one written in.
        /// </summary>
        /// <typeparam name="T">AIngle type to test</typeparam>
        /// <param name="t">Value for the AIngle type to test.</param>
