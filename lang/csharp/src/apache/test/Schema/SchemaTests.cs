...
namespace AIngle.Test
{
    ...
    public class SchemaTests
    {
        ...
        [TestCase("{\"type\": \"fixed\", \"name\": \"MyFixed\", \"namespace\": \"org.apache.hadoop.aingle\", \"size\": 1}")]
        ...
        private static void testToString(Schema sc)
        {
            ...
            {
                throw new AIngleException(e.ToString() + ": " + sc.ToString(), e);
            }
        }
        ...
        {
            var err = Assert.Throws<AIngleTypeException>(() => Schema.Parse(s));
