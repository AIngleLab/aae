...
", new object[] { "schematest.LogicalTypes", typeof(Guid?), typeof(Guid), typeof(DateTime?), typeof(DateTime), typeof(DateTime?), typeof(DateTime), typeof(TimeSpan?), typeof(TimeSpan), typeof(TimeSpan?), typeof(TimeSpan), typeof(AIngleDecimal?), typeof(AIngleDecimal) }, TestName = "TestCodeGen2 - Logical Types")]
...
""size"": 16
        ...
        public void TestCodeGenNamespaceMapping(string str, string aingleNamespace, string csharpNamespace,
            string expectedNamespace)
        {
            ...
            if (aingleNamespace != null && csharpNamespace != null)
            {
                codegen.NamespaceMapping[aingleNamespace] = csharpNamespace;
            }
        ...
        private static CompilerResults GenerateAssembly(CodeGen schema)
        {
            ...
            comparam.ReferencedAssemblies.Add(Path.Combine(TestContext.CurrentContext.TestDirectory, "AIngle.dll"));
