        ...
        public object GetDefaultValue(Schema s, JToken defaultValue)
        {
            ...
            switch (s.Tag)
            {
                case Schema.Type.Boolean:
                    ...
                    {
                        throw new AIngleException("Default boolean value " + defaultValue.ToString() + " is invalid, expected is json boolean.");
                    }
                ...
                case Schema.Type.Int:
                    ...
                    {
                        throw new AIngleException("Default int value " + defaultValue.ToString() + " is invalid, expected is json integer.");
                    }
                ...
                case Schema.Type.Long:
                    if (defaultValue.Type != JTokenType.Integer)
                    {
                        throw new AIngleException("Default long value " + defaultValue.ToString() + " is invalid, expected is json integer.");
                    }
                ...
                case Schema.Type.Float:
                    ...
                    {
                        throw new AIngleException("Default float value " + defaultValue.ToString() + " is invalid, expected is json number.");
                    }
                ...
                case Schema.Type.Double:
                    ...
                    {
                        throw new AIngleException("Default double value " + defaultValue.ToString() + " is invalid, expected is json number.");
                    }

                case Schema.Type.Bytes:
                    if (defaultValue.Type != JTokenType.String)
                    {
                        throw new AIngleException("Default bytes value " + defaultValue.ToString() + " is invalid, expected is json string.");
                    }
                ...
                case Schema.Type.Fixed:
                    if (defaultValue.Type != JTokenType.String)
                    {
                        throw new AIngleException("Default fixed value " + defaultValue.ToString() + " is invalid, expected is json string.");
                    }
                    ...
                    if (bb.Length != len)
                    {
                        throw new AIngleException("Default fixed value " + defaultValue.ToString() + " is not of expected length " + len);
                    }
                ...
                case Schema.Type.String:
                    if (defaultValue.Type != JTokenType.String)
                    {
                        throw new AIngleException("Default string value " + defaultValue.ToString() + " is invalid, expected is json string.");
                    }
                ...
                case Schema.Type.Enumeration:
                    if (defaultValue.Type != JTokenType.String)
                    {
                        throw new AIngleException("Default enum value " + defaultValue.ToString() + " is invalid, expected is json string.");
                    }
                ...
                case Schema.Type.Null:
                    ...
                    {
                        throw new AIngleException("Default null value " + defaultValue.ToString() + " is invalid, expected is json null.");
                    }
                ...
                case Schema.Type.Array:
                    ...
                    {
                        throw new AIngleException("Default array value " + defaultValue.ToString() + " is invalid, expected is json array.");
                    }
                ...
                case Schema.Type.Error:
                    ...
                    {
                        throw new AIngleException($"Default record value {defaultValue.ToString()} is invalid, expected is json object.");
                    }
                ...
                case Schema.Type.Map:
                    if (defaultValue.Type != JTokenType.Object)
                    {
                        throw new AIngleException($"Default map value {defaultValue.ToString()} is invalid, expected is json object.");
                    }
                ...
                default:
                    throw new AIngleException($"Unsupported schema type {s.Tag}");
            }
        }
...
//                        obj = _classCache.GetClass(writerSchema).GetValue(rec, rf);
                ...
                {
                    throw new AIngleException(ex.Message + " in field " + wf.Name, ex);
                }
            }
        ...
        protected override object ReadFixed(object reuse, FixedSchema writerSchema, Schema readerSchema, Decoder d)
        {
            ...
            {
                throw new AIngleException($"Size mismatch between reader and writer fixed schemas. Writer: {writerSchema}, reader: {readerSchema}");
            }
        ...
        protected override object ReadArray(object reuse, ArraySchema writerSchema, Schema readerSchema, Decoder dec)
        {
            ...
            if (reuse != null)
            {
                ...
                if (array == null)
                    throw new AIngleException("array object is not an IEnumerable");
        ...
        protected override object ReadMap(object reuse, MapSchema writerSchema, Schema readerSchema, Decoder d)
        {
            ...
            if (reuse != null)
            {
                ...
                if (map == null)
                    throw new AIngleException("map object does not implement IDictionary");
