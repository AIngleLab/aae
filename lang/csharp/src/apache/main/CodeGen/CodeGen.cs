...
{
    /// <summary>
    /// Generates C# code from AIngle schemas and protocols.
    /// </summary>
    public class CodeGen
    {
        ...
        /// <summary>
        /// Mapping of AIngle namespaces to C# namespaces
        /// </summary>
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected virtual void processInterface(Protocol protocol)
        {
            ...
            ctd.IsClass = true;
            ctd.BaseTypes.Add("AIngle.Specific.ISpecificProtocol");
            ...
            protocolField.Type = new CodeTypeReference("readonly AIngle.Protocol");
            ...
            property.Type = new CodeTypeReference("AIngle.Protocol");
        ...
        private static CodeMemberMethod CreateRequestMethod()
        {
            ...
            {
                var requestor = new CodeParameterDeclarationExpression(typeof (AIngle.Specific.ICallbackRequestor),
                                                                       "requestor");
        ...
        private static void AddMethods(Protocol protocol, bool generateCallback, CodeTypeDeclaration ctd)
        {
            foreach (var e in protocol.Messages)
            {
                ...
                if (generateCallback)
                {
                    ...
                    var parameter = new CodeParameterDeclarationExpression("AIngle.IO.ICallback<" + type + ">",
                                                                           "callback");
                    messageMember.Parameters.Add(parameter);
                }
        ...
        protected virtual CodeTypeDeclaration processRecord(Schema schema)
        {
            ...
            getFieldStmt.AppendLine("\t\t\tdefault: throw new AIngleRuntimeException(\"Bad index \" + fieldPos + \" in Get()\");")
                .Append("\t\t\t}");
            ...
            putFieldStmt.AppendLine("\t\t\tdefault: throw new AIngleRuntimeException(\"Bad index \" + fieldPos + \" in Put()\");")
                .Append("\t\t\t}");
