    ...
    public class SpecificDefaultReader : DefaultReader
    {
        ...
        protected override object ReadArray(object reuse, ArraySchema writerSchema, Schema readerSchema, Decoder dec)
        {
            ...
            if (reuse != null)
            {
                ...
                if (array == null)
                    throw new AIngleException("array object does not implement non-generic IList");
        ...
        protected override object ReadMap(object reuse, MapSchema writerSchema, Schema readerSchema, Decoder d)
        {
            ...
            if (reuse != null)
            {
                ...
                if (map == null)
                    throw new AIngleException("map object does not implement non-generic IList");
        ...
        {
            bool nEnum = false;
            string type = AIngle.CodeGen.getType(schema, false, ref nEnum);
