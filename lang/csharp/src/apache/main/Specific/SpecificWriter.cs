...
namespace AIngle.Specific
{
    ...
    public class SpecificDefaultWriter : DefaultWriter
    {
        ...
        protected override void WriteRecord(RecordSchema schema, object value, Encoder encoder)
        {
            ...
            if (rec == null)
                throw new AIngleTypeException("Record object is not derived from ISpecificRecord");
        ...
        protected override void WriteFixed(FixedSchema schema, object value, Encoder encoder)
        {
            ...
            if (fixedrec == null)
                throw new AIngleTypeException("Fixed object is not derived from SpecificFixed");
        ...
        {
            if (value == null)
                throw new AIngleTypeException("value is null in SpecificDefaultWriter.WriteEnum");
        ...
        protected override void WriteArray(ArraySchema schema, object value, Encoder encoder)
        {
            ...
            if (arr == null)
                throw new AIngleTypeException("Array does not implement non-generic IList");
        ...
        protected override void WriteMap(MapSchema schema, object value, Encoder encoder)
        {
            ...
            if (map == null)
                throw new AIngleTypeException("Map does not implement non-generic IDictionary");
        ...
        protected override void WriteUnion(UnionSchema us, object value, Encoder encoder)
        {
            ...
            throw new AIngleException("Cannot find a match for " + value.GetType() + " in " + us);
        }
