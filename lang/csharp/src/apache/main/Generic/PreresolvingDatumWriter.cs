...
{
    /// <summary>
    /// A general purpose writer of data from aingle streams. This writer analyzes the writer schema
    ...
    public abstract class PreresolvingDatumWriter<T> : DatumWriter<T>
    {
        ...
        /// </returns>
        /// <exception cref="AIngleException">
        ...
        protected static AIngleException TypeMismatch(object obj, string schemaType, string type)
        {
