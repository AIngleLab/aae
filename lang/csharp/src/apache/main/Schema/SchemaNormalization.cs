...
namespace AIngle
{
    ...
    public static class SchemaNormalization
    {
        ...
        /// <summary>
        /// Parses a schema into the canonical form as defined by AIngle spec.
        /// </summary>
        /// <param name="s">Schema</param>
        /// <returns>Parsing Canonical Form of a schema as defined by AIngle spec.</returns>
        ...
        /// <code>"CRC-64-AINGLE"</code>, then the result of <see cref="Fingerprint64(byte[])"/> is
        ...
        /// </para>
        /// <para> Recommended AIngle practice dictiates that
        /// <code>"CRC-64-AINGLE"</code> is used for 64-bit fingerprints,
        ...
        /// <summary>
        /// Computes the 64-bit Rabin Fingerprint (as recommended in the AIngle spec) of a byte string.
        /// </summary>
        /// <param name="data">Data to be hashed.</param>
        /// <returns>Fingerprint</returns>
