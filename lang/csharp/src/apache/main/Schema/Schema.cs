...
namespace AIngle
{
    ...
    public abstract class Schema
    {
        ...
        /// <summary>
        /// Additional JSON attributes apart from those defined in the AINGLE spec
        /// </summary>
        ...
        internal static Schema ParseJson(JToken jtok, SchemaNames names, string encspace)
        {
            ...
            throw new AIngleTypeException($"Invalid JSON for schema: {jtok} at '{jtok.Path}'");
        }
        ...
        /// <summary>
        /// Static function to parse custom properties (not defined in the AIngle spec) from the given JSON object
        /// </summary>
        ...
        /// according to the AIngle resolution rules.
        /// </summary>
