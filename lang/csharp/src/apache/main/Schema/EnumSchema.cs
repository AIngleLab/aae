...
namespace AIngle
{
    ...
    public class EnumSchema : NamedSchema
    {
        ...
        /// Throws AIngleException if the symbol is not found in this enum.
        /// </summary>
        ...
        public int Ordinal(string symbol)
        {
            ...
            throw new AIngleException("No such symbol: " + symbol);
        }
        ...
        public string this[int index]
        {
            get
            {
                ...
                throw new AIngleException("Enumeration out of range. Must be less than " + Symbols.Count + ", but is " + index);
            }
        }
