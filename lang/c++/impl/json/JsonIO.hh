...
#ifndef aingle_json_JsonIO_hh__
#define aingle_json_JsonIO_hh__
...
class AINGLE_DECL JsonParser : boost::noncopyable {
public:
    enum class Token {
        Null,
        Bool,
...
class AINGLE_DECL JsonNullFormatter {
public:
...
class AINGLE_DECL JsonPrettyFormatter {
    StreamWriter &out_;
    size_t level_;
