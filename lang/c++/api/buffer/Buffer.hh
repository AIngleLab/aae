...
#ifndef aingle_Buffer_hh__
#define aingle_Buffer_hh__
...
class AINGLE_DECL OutputBuffer {
...
public:
     ...
     * fact that the underlying aingle of buffers will not be modified, even
