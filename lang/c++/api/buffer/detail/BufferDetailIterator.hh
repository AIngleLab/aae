...
#ifndef aingle_BufferDetailIterator_hh__
#define aingle_BufferDetailIterator_hh__
 ...
 *
 * Iterators for an InputBuffer will iterate over the aingle of chunks, so
 ...
 *
 * Iterators for an OutputBuffer will iterate over the aingle of chunks, so
 * internally they contain an iterator.  But the iterator needs to be
 * convertable to an asio buffer for use in boost::asio functions.  This class
 * wraps the iterator with a cast operator to do this conversion.
 */
