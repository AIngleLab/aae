...
#ifndef aingle_BufferStream_hh__
#define aingle_BufferStream_hh__
...
class AINGLE_DECL ostream : public std::ostream {
...
class AINGLE_DECL istream : public std::istream {
