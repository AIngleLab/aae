...
#ifndef aingle_BufferStreambuf_hh__
#define aingle_BufferStreambuf_hh__
...
class AINGLE_DECL ostreambuf : public std::streambuf {
...
class AINGLE_DECL istreambuf : public std::streambuf {
