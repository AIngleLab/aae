...
#ifndef aingle_Node_hh__
#define aingle_Node_hh__
...
/// Node is the building block for parse trees.  Each node represents an aingle
...
class AINGLE_DECL Node : private boost::noncopyable {
public:
...
namespace std {
inline std::ostream &operator<<(std::ostream &os, const aingle::Node &n) {
    n.printJson(os, 0);
    return os;
}
} // namespace std
