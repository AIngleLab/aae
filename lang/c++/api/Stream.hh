...
#ifndef aingle_Stream_hh__
#define aingle_Stream_hh__
 ...
 */
class AINGLE_DECL InputStream : boost::noncopyable {
protected:
    /**
 ...
 */
class AINGLE_DECL SeekableInputStream : public InputStream {
protected:
    /**
     * An empty constructor.
     */
 ...
 */
class AINGLE_DECL OutputStream : boost::noncopyable {
protected:
    /**
     * An empty constructor.
     */
 ...
 */
AINGLE_DECL OutputStreamPtr memoryOutputStream(size_t chunkSize = 4 * 1024);
 ...
 */
AINGLE_DECL InputStreamPtr memoryInputStream(const uint8_t *data, size_t len);
 ...
 */
AINGLE_DECL InputStreamPtr memoryInputStream(const OutputStream &source);
 ...
 */
AINGLE_DECL std::shared_ptr<std::vector<uint8_t>> snapshot(const OutputStream &source);
 ...
 */
AINGLE_DECL OutputStreamPtr fileOutputStream(const char *filename,
 ...
 */
AINGLE_DECL InputStreamPtr fileInputStream(
    const char *filename, size_t bufferSize = 8 * 1024);
AINGLE_DECL SeekableInputStreamPtr fileSeekableInputStream(
    const char *filename, size_t bufferSize = 8 * 1024);
 ...
 * OutputStream.
 */
AINGLE_DECL OutputStreamPtr ostreamOutputStream(std::ostream &os,
                                              size_t bufferSize = 8 * 1024);
 ...
 * InputStream.
 */
AINGLE_DECL InputStreamPtr istreamInputStream(
 ...
 * InputStream.
 */
AINGLE_DECL InputStreamPtr nonSeekableIstreamInputStream(
