...
init_unit_test_suite(int /*argc*/, char * /*argv*/[]) {
    ...
    ts->add(BOOST_TEST_CASE(aingle::specific::testBool));
    ts->add(BOOST_TEST_CASE(aingle::specific::testInt));
    ts->add(BOOST_TEST_CASE(aingle::specific::testLong));
    ts->add(BOOST_TEST_CASE(aingle::specific::testFloat));
    ts->add(BOOST_TEST_CASE(aingle::specific::testDouble));
    ts->add(BOOST_TEST_CASE(aingle::specific::testString));
    ts->add(BOOST_TEST_CASE(aingle::specific::testBytes));
    ts->add(BOOST_TEST_CASE(aingle::specific::testFixed));
    ts->add(BOOST_TEST_CASE(aingle::specific::testArray));
    ts->add(BOOST_TEST_CASE(aingle::specific::testBoolArray));
    ts->add(BOOST_TEST_CASE(aingle::specific::testMap));
    ts->add(BOOST_TEST_CASE(aingle::specific::testCustom));
    return ts;
}
