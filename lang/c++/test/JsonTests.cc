...
init_unit_test_suite(int /* argc */, char * /* argv */[]) {
    ...
    auto *ts = BOOST_TEST_SUITE("AIngle C++ unit tests for json routines");

    ts->add(BOOST_TEST_CASE(&aingle::json::testNull));
    ts->add(BOOST_PARAM_TEST_CASE(&aingle::json::testBool,
                                  aingle::json::boolData,
                                  aingle::json::boolData + COUNT_OF(aingle::json::boolData)));
    ts->add(BOOST_PARAM_TEST_CASE(&aingle::json::testLong,
                                  aingle::json::longData,
                                  aingle::json::longData + COUNT_OF(aingle::json::longData)));
    ts->add(BOOST_PARAM_TEST_CASE(&aingle::json::testDouble,
                                  aingle::json::doubleData,
                                  aingle::json::doubleData + COUNT_OF(aingle::json::doubleData)));
    ts->add(BOOST_PARAM_TEST_CASE(&aingle::json::testString,
                                  aingle::json::stringData,
                                  aingle::json::stringData + COUNT_OF(aingle::json::stringData)));

    ts->add(BOOST_TEST_CASE(&aingle::json::testArray0));
    ts->add(BOOST_TEST_CASE(&aingle::json::testArray1));
    ts->add(BOOST_TEST_CASE(&aingle::json::testArray2));

    ts->add(BOOST_TEST_CASE(&aingle::json::testObject0));
    ts->add(BOOST_TEST_CASE(&aingle::json::testObject1));
    ts->add(BOOST_TEST_CASE(&aingle::json::testObject2));
