...
//! Port of https://github.com/AIngleLab/aae/blob/release-1.9.1/lang/py/test/test_schema.py
use aingle_rs::{schema::Name, Error, Schema};
...
#[test]
/// Test that the string generated by an AIngle Schema object is, in fact, a valid AIngle schema.
...
#[test]
/// 1. Given a string, parse it to get AIngle schema "original".
/// 2. Serialize "original" to a string and parse that string to generate AIngle schema "round trip".
