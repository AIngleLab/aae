...
/// Implementation of the Rabin fingerprint algorithm using the Digest trait as described in [schema_fingerprints](https://apache.aingle.ai/docs/current/spec.html#schema_fingerprints).
///
/// The digest is returned as the 8-byte little-endian encoding of the Rabin hash.
/// This is what is used for aingle [single object encoding](https://apache.aingle.ai/docs/current/spec.html#single_object_encoding)
///
/// ```rust
...
impl FixedOutput for Rabin {
    ...
    // See: https://apache.aingle.ai/docs/current/spec.html#single_object_encoding
    type OutputSize = U8;
...
mod tests {
    ...
    // See: https://github.com/AIngleLab/aae/blob/master/share/test/data/schema-tests.txt
    #[test]
    fn test1() {
        let data: &[(&str, i64)] = &[
