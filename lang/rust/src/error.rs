...
pub enum Error {
    ...
    /// Describes errors happened while validating AIngle data.
    ...
    #[error("Failed to get JSON from aingle.schema key in map")]
    GetAIngleSchemaFromMap,
    ...
    #[error("Failed to serialize value into AIngle value: {0}")]
    SerializeValue(String),

    #[error("Failed to deserialize AIngle value into value: {0}")]
    ...
    #[error("failed to convert aingle float to json: {0}")]
