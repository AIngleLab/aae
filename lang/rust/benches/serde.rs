...
// This benchmark reads from the `benches/quickstop-null.aingle` file, which was pulled from
// the `goaingle` project benchmarks:
// https://github.com/linkedin/goaingle/blob/master/fixtures/quickstop-null.aingle
// This was done for the sake of comparing this crate against the `goaingle` implementation.
fn bench_file_quickstop_null(c: &mut Criterion) {
    bench_from_file(c, "benches/quickstop-null.aingle", "quickstop null file");
}
