...
### Added
- Support to convert aingle value to json value (#155)
- Implement deserialize for Uuid (#153)

## Deprecated
- Deprecate ToAIngle in favor of From<T> for Value implementations (#137)
...
- bench_from_file function and a file from the goaingle repository for comparison
...
## [0.2.0] - 2018-05-22
### Added
- `from_aingle_datum` to decode AIngle-encoded bytes into a `Value`
