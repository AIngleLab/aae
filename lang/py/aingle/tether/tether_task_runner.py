...
class TaskRunnerResponder(aingle.ipc.Responder):
    """
    ...
    def __init__(self, runner):
        ...
        """
        aingle.ipc.Responder.__init__(self, aingle.tether.tether_task.inputProtocol)
...
class TaskRunner:
    ...
    def __init__(self, task):
        ...
        if not isinstance(task, aingle.tether.tether_task.TetherTask):
            raise aingle.errors.AIngleException("task must be an instance of tether task")
        self.task = task
    ...
    def start(self, outputport=None, join=True):
        ...
        join       - (optional) If set to fault then we don't issue a join to block
                    ...
                    testing
        """
        port = aingle.tether.util.find_port()
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise aingle.errors.UsageError("Usage: tether_task_runner task_package.task_module.TaskClass")
    ...
    except aingle.errors.AIngleException as e:
        raise aingle.errors.UsageError(e)
