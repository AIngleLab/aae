...
from aingle.errors import AIngleRuntimeException
from aingle.schema import (
    ArraySchema,
    EnumSchema,
    Field,
    FixedSchema,
...
class ReaderWriterCompatibilityChecker:
    ...
    def calculate_compatibility(
        ...
        :param reader: aingle.schema.Schema
        :param writer: aingle.schema.Schema
        ...
        if reader.type == writer.type:
            ...
            if reader.type == SchemaType.UNION:
                ...
                return result
            raise AIngleRuntimeException(f"Unknown schema type: {reader.type}")
