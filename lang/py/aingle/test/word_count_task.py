...
class WordCountTask(aingle.tether.tether_task.TetherTask):
    """
    ...
    def __init__(self):
        ...
        midschema = """{"type":"record", "name":"Pair","namespace":"org.apache.aingle.mapred","fields":[
              {"name":"key","type":"string"},
              {"name":"value","type":"long","order":"ignore"}]
              }"""
        outschema = midschema
        aingle.tether.tether_task.TetherTask.__init__(self, inschema, midschema, outschema)
