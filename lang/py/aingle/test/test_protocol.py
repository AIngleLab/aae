...
class TestProtocol:
    ...
    def parse(self):
        return aingle.protocol.parse(str(self))
    ...
    ValidTestProtocol(
        {
            ...
            "types": [
                ...
                {
                    "name": "TestError",
                    "namespace": "org.apache.aingle.test.errors",
                    "type": "error",
                    "fields": [{"name": "message", "type": "string"}],
                },
            ],
    ...
    ValidTestProtocol(
        {
            ...
            "types": [
                ...
                },
                {
                    ...
                    "type": "record",
                    "fields": [
                        {"name": "hash", "type": "org.apache.aingle.test.util.MD5"},
...
class ProtocolParseTestCase(unittest.TestCase):
    ...
    def parse_valid(self):
        ...
        except aingle.errors.ProtocolParseException:  # pragma: no coverage
    ...
    def parse_invalid(self):
        ...
        with self.assertRaises(
            (aingle.errors.ProtocolParseException, aingle.errors.SchemaParseException),
...
class RoundTripParseTestCase(unittest.TestCase):
    ...
    def parse_round_trip(self):
        ...
        round_trip = aingle.protocol.parse(str(parsed))
