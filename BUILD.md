# Apache AIngle Build Instructions

## Requirements

The following packages must be installed before AIngle can be built:
...
```bash
./build.sh docker
docker@539f6535c9db:~/aingle$ cd lang/java/
docker@539f6535c9db:~/aingle/lang/java$ ./build.sh test
...
allows you to access the files in your AIngle development tree from the
Docker container.
...
DOCKER_IMAGE_NAME=aingle-build:1.10.1-rc1 ./build.sh docker
